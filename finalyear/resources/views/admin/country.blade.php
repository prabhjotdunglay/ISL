            ...
            <div class="card">
                ...
                <div class="card-body">
                    <div class="table-responsive">
                        <table class="table">
                            <form class="form-detail" action={{route('country.store')}} method="post">
                                @csrf
                                @if(count($errors)>0)
                                ...
                                <form>
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" name="name" id="name" placeholder="Enter Country Name" required>
